...
import org.eclipse.smarthome.binding.mqtt.generic.handler.ThingChannelConstants;
 ...
 */
public class ImplementationTest extends JavaOSGiTest {
    final Logger logger = LoggerFactory.getLogger(ImplementationTest.class);
    // private EmbeddedBrokerService mqttService;
    ...
    public void setUp()
        ...
        initMocks(this);
        // mqttService = getService(EmbeddedBrokerService.class);
        // embeddedConnection = mqttService.getConnection();
