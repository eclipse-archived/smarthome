...
import org.eclipse.smarthome.binding.mqtt.generic.handler.ChannelStateWithTransformation;
import org.eclipse.smarthome.binding.mqtt.generic.handler.GenericThingHandler;
...
public class ThingHandlerTransformationPatternTest {
    ...
    public void setUp() throws ConfigurationException, MqttException {
        ...
        thingHandler = spy(
                new GenericThingHandler(thing, mock(MqttChannelTypeProvider.class), transformationServiceProvider));
    ...
    public void initialize() throws MqttException {
        ...
        ChannelStateWithTransformation channelConfig = (ChannelStateWithTransformation) thingHandler.channelDataByChannelUID
                .get(textChannelUID);
    ...
    public void processMessageWithJSONPath() throws Exception {
        ...
        ChannelStateWithTransformation channelConfig = (ChannelStateWithTransformation) thingHandler.channelDataByChannelUID
                .get(textChannelUID);
        channelConfig.channelStateUpdateListener = thingHandler;
        // doReturn(new TextValue("TEST")).when(channelConfig).getValue();
        byte payload[] = jsonPathJSON.getBytes();
        assertThat(channelConfig.transformationPattern, is(jsonPathPattern));
        // Test process message
        channelConfig.processMessage(channelConfig.getTopic(), payload);
