...
import static org.eclipse.smarthome.binding.mqtt.generic.handler.ThingChannelConstants.testHomieThing;
...
public class HomieThingHandlerTests {
    ...
    public void handleCommandUpdate() throws MqttException {
        ...
        property.getChannelState().connection = connection; // Pretend we called start()
        thingHandler.connection = connection;
