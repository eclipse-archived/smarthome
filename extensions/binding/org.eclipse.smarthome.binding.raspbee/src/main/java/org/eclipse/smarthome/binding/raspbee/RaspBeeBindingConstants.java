 ...
 */
package org.eclipse.smarthome.binding.raspbee;

import org.eclipse.smarthome.core.thing.ThingTypeUID;

/**
 * The {@link RaspBeeBindingConstants} class defines common constants, which are
 * used across the whole binding.
 *
 * @author Kai Kreuzer - Initial contribution
 * @author Jochen Hiller - Added OSRAM Classic A60 RGBW
 * @author Markus Mazurczak - Added OSRAM PAR16 50
 * @author Fatih Boy - BindingId modified for raspbee, port number added
 */
public class RaspBeeBindingConstants {

    public static final String BINDING_ID = "raspbee";

    // List all Thing Type UIDs, related to the RaspBee Binding
