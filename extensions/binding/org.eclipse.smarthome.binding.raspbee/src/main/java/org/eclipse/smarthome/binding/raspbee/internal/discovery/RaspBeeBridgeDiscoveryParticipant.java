...
/**
 * The {@link RaspBeeBridgeDiscoveryParticipant} is responsible for discovering new and
 ...
 */
public class RaspBeeBridgeDiscoveryParticipant implements UpnpDiscoveryParticipant {
    ...
    public DiscoveryResult createResult(RemoteDevice device) {
        ...
        if (uid != null) {
            ...
            properties.put(HOST, descriptorURL.getHost());
            properties.put(PORT, Integer.toString(descriptorURL.getPort()));
