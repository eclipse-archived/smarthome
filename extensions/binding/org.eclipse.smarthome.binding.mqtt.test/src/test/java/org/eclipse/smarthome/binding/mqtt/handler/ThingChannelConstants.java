...
import static org.eclipse.smarthome.binding.mqtt.MqttBrokerBindingConstants.*;
...
import org.eclipse.smarthome.binding.mqtt.internal.discovery.MqttServiceDiscoveryService;
...
public class ThingChannelConstants {
    ...
    final public static ChannelTypeUID numberChannel = new ChannelTypeUID(BINDING_ID, NUMBER_CHANNEL);
    final public static ChannelTypeUID percentageChannel = new ChannelTypeUID(BINDING_ID, PERCENTAGE_CHANNEL);
    final public static ChannelTypeUID unknownChannel = new ChannelTypeUID(BINDING_ID, "unknown");

    final public static ChannelUID textChannelUID = new ChannelUID(testThing, "mytext");
    ...
    public static Channel cb(String id, String acceptedType, Configuration config, ChannelTypeUID channelTypeUID) {
        return ChannelBuilder.create(new ChannelUID(testThing, id), acceptedType).withConfiguration(config)
