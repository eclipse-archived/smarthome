...
/**
 * The {@link BleCharacteristic} class defines the BLE Service.
 * <p>
...
public class BleService {
    ...
    /**
     * Map of {@link BleCharacteristic}s supported in this service
     */
    protected final Map<UUID, BleCharacteristic> supportedCharacteristics = new HashMap<UUID, BleCharacteristic>();

    public BleService(UUID uuid) {
        this(uuid, true, 0, 0);
    }

    public BleService(UUID uuid, boolean primaryService) {
        this(uuid, primaryService, 0, 0);
    }

    public BleService(UUID uuid, boolean primaryService, int handleStart, int handleEnd) {
        this.uuid = uuid;
     ...
     *
     * @return the {@link BleCharacteristic} with the requested {@link UUID}
     */
     ...
     *
     * @return the list of {@link BleCharacteristic}s
     */
    public List<BleCharacteristic> getCharacteristics() {
        return new ArrayList<BleCharacteristic>(supportedCharacteristics.values());
    }
     ...
     */
    public boolean addCharacteristic(BleCharacteristic characteristic) {
     ...
     * @return return the {@link BleCharacteristic} or null if not found
     */
    public BleCharacteristic getCharacteristicByHandle(int handle) {
        synchronized (supportedCharacteristics) {
            for (BleCharacteristic characteristic : supportedCharacteristics.values()) {
    ...
    public String toString() {
        ...
        builder.append("BleService [uuid=");
        builder.append(uuid);
