...
/**
 * The {@link BleCharacteristic} class defines the BLE Characteristic.
 * <p>
...
public class BleCharacteristic {
    ...
    /**
     * A map of {@link BleDescriptor}s applicable to this characteristic
     */
    protected Map<UUID, BleDescriptor> gattDescriptors = new HashMap<UUID, BleDescriptor>();
    ...
    /**
     * The {@link BleService} to which this characteristic belongs
     */
    protected BleService service;

    /**
     * Create a new BleCharacteristic.
     *
     * @param uuid the {@link UUID} of the new characteristic
     * @param handle
     */
    public BleCharacteristic(UUID uuid, int handle) {
        this.uuid = uuid;
        this.handle = handle;
    }
     ...
     *
     * @param descriptor {@link BleDescriptor} to be added to this characteristic.
     * @return true, if the descriptor was added to the characteristic
     */
    public boolean addDescriptor(BleDescriptor descriptor) {
    ...
    public List<BleDescriptor> getDescriptors() {
        return new ArrayList<BleDescriptor>(gattDescriptors.values());
    }
     ...
     *
     * @return the {@link BleDescriptor}
     */
    public BleDescriptor getDescriptor(UUID uuid) {
