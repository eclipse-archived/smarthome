...
public class Homie300Discovery extends AbstractDiscoveryService implements TopicDiscovered {
    ...
    public void topicDiscovered(ThingUID connectionBridge, MqttBrokerConnection connection, String topic,
        ...
        thingDiscovered(DiscoveryResultBuilder.create(new ThingUID(MqttBindingConstants.HOMIE300_MQTT_THING, connectionBridge, deviceID)).withProperties(properties)
                .withRepresentationProperty("deviceid").withLabel("Homie device").build());
    }
