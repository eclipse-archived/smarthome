...
```
# Note:
The channel syntax is a bit different if the things (broker and thing) are created via PaperUI. In this case the "mybroker" is ommitted. The actually correct syntax can be copied from PaperUI in any case! 
