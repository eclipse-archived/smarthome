 ...
 *
 */
public class WemoLinkDiscoveryService extends AbstractDiscoveryService implements UpnpIOParticipant, DiscoveryListener {
    ...
    public WemoLinkDiscoveryService(WemoBridgeHandler wemoBridgeHandler, UpnpIOService upnpIOService) {
        ...
        this.scanningRunnable = new WemoLinkScan(this);
    ...
    protected void startScan() {
        ...
        try {
            ...
            String devUDN = wemoBridgeHandler.getThing().getConfiguration().get(ROOT_UDN).toString();
                    ...
                    try {
                        ...
                        for (int i = 0; i < nodes.getLength(); i++) {
                            ...
                            if (SUPPORTED_THING_TYPES.contains(new ThingTypeUID(BINDING_ID, endDeviceModelID))) {
                                ...
                                logger.info("Discovered an unsupported device :");
                                logger.info("DeviceIndex : " + getCharacterDataFromElement(line));
                                logger.info("DeviceID    : " + endDeviceID);
                                logger.info("FriendlyName: " + endDeviceName);
                                logger.info("Manufacturer: " + endDeviceVendor);
                                logger.info("ModelCode   : " + endDeviceModelID);
                            }
    ...
    public class WemoLinkScan implements Runnable {
        ...
        private WemoLinkDiscoveryService service;

        public WemoLinkScan(WemoLinkDiscoveryService service) {
