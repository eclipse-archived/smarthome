...
angular.module('PaperUI.controllers.rules', []).controller('RulesPageController',
		...
		function($scope, $timeout, ruleRepository, ruleService, toastService, sharedProperties) {
	...
	ruleRepository.getOne(function(rule) {
		...
		function($scope, itemRepository, ruleService, toastService, $mdDialog, sharedProperties) {
