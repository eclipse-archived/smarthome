 ...
 * folder and tries to extract binding information from them. Any {@link BindingInfo}
 * objects are registered as service at the <i>OSGi</i> service registry and unregistered
...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        ...
        XmlDocumentProviderFactory<BindingInfoXmlResult> bindingInfoProviderFactory =
                new BindingInfoXmlProviderFactory(context, configDescriptionProvider);
