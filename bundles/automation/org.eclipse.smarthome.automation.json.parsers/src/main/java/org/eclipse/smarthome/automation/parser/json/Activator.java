  ...
  public void start(BundleContext context) throws Exception {
    ...
    Filter filter = context.createFilter(
        "(|(objectClass=" + TemplateRegistry.class.getName()
            + ")(objectClass=" + AutomationFactory.class.getName()
  ...
  public Object addingService(ServiceReference reference) {
    ...
    if (moduleManager != null && automationFactory != null) {
      if (mpReg == null) {
        ...
        mpReg = (ServiceRegistration /*<Parser>*/) bc.registerService(Parser.class.getName(),
            new ModuleTypeJSONParser(bc, moduleManager, automationFactory), props);
      }
      if (templateManager != null) {
        if (tpReg == null) {
          Dictionary<String, String> props = new Hashtable<String, String>(1);
          props.put(Parser.PARSER_TYPE, Parser.PARSER_TEMPLATE);
          tpReg = (ServiceRegistration /*<Parser>*/) bc.registerService(Parser.class.getName(),
              new TemplateJSONParser(bc, moduleManager, templateManager, automationFactory), props);
        }
        if (rpReg == null) {
          Dictionary<String, String> props = new Hashtable<String, String>(1);
          props.put(Parser.PARSER_TYPE, Parser.PARSER_RULE);
          rpReg = (ServiceRegistration /*<Parser>*/) bc.registerService(Parser.class.getName(), new RuleJSONParser(
              bc, templateManager, moduleManager, automationFactory), props);
        }
      }
    }
    return service;
