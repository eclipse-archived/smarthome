...
public class ActionTypeJSONParser {
    ...
    static boolean validateActionConnections(BundleContext bc, Set<Connection> connections, Action action,
            Map<String, Trigger> triggersMap, Map<String, Action> actionsMap, ModuleTypeManager moduleManager,
            Status status) {
        boolean res = true;
        ...
        while (connectionsI.hasNext()) {
            ...
            String inputType = inputs.get(connection.getInputName()).getType();
