 ...
 *
 */
public class AutomationCommandsPluggable extends AutomationCommands implements
	...
	public AutomationCommandsPluggable(BundleContext bc) {
		...
		try {
			Filter filter = bc.createFilter(
					"(|(objectClass=" + RuleRegistry.class.getName()
					+ ")(objectClass=" + TemplateRegistry.class.getName()
					+ ")(objectClass=" + ModuleTypeRegistry.class.getName()
					+ "))");
	...
	public List<String> getUsages() {
		return Arrays.asList(new String[] {
			...
			buildCommandUsage(REMOVE_RULE + " [-st] <uid>",
				"Removes the rule, specified by given UID"),
	...
	/**
	 * @see com.prosyst.mbs.impl.services.automation.commands.AutomationCommands#getTemplate(java.lang.String, java.util.Locale)
	 */
	...
	/**
	 * @see com.prosyst.mbs.impl.services.automation.commands.AutomationCommands#getModuleType(java.lang.String, java.util.Locale)
	 */
	...
	/**
	 * @see com.prosyst.mbs.impl.services.automation.commands.AutomationCommands#getModuleTypes(java.lang.Class, java.lang.String)
	 */
	 ...
	 * @return a usage string that complies to a standard format
	 */
	protected String buildCommandUsage(final String syntax,
