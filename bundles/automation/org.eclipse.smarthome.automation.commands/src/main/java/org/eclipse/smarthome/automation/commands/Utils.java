...
public class Utils {
  ...
  static Hashtable<String, String> filterList(Hashtable<String, ?> listObjects,
      Hashtable<String, String> listUIDs) {
  ...
  private static void quickSort(String[] a, int begin, int length, boolean ignoreCase) {
    ...
    if (ignoreCase) {
      if (length == 2
          && a[begin].toLowerCase().compareTo(
              a[begin + 1].toLowerCase()) > 0) {
  ...
  private static void backquickSort(String[] a, int begin, int length,
      boolean ignoreCase) {
    int i, j, leftLength, rightLength, t;
    String x;
    while (length >= 3) {
