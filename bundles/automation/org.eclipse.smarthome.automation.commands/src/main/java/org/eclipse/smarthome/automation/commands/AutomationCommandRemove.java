...
public class AutomationCommandRemove extends AutomationCommand {
   ...
   * @param options
   */
  public AutomationCommandRemove(String command, String[] params, int adminType, AutomationCommandsPluggable autoCommands) {
  ...
  public String execute() {
    ...
    switch (adminType) {
      case AutomationCommands.MODULE_TYPE_ADMIN:
        ...
        return String.format("[Automation Commands : Command \"%s\"] %s! ModuleTypeProvider not available!", command,
            FAIL);
