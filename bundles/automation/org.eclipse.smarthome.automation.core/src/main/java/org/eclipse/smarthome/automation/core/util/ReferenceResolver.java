...
public class ReferenceResolver {
    ...
    private final static String regex = "(\\[{1}\\\"{1}.*\\\"{1}\\]{1}|\\[{1}\\d*\\]{1}|[^\\[\\]\\.]\\w+[^\\]\\[\\.])";
     ...
     * @throws IllegalArgumentException if the reference has invalid syntax.
     */
    public static String[] splitReferenceToTokens(String reference) throws IllegalArgumentException {
        ...
        if (reference.isEmpty() || reference.startsWith(".") || reference.endsWith(".") || reference.endsWith("[")
