...
package org.eclipse.smarthome.automation.handler.parser;
...
public interface Parser {
   ...
   * <p> Example : "parser.type" = "parser.module.type";
   ...
   * <p> Example : "format" = "json";
   * It is used as registration property of the corresponding service.
   */
  public static String FORMAT = "format";
  
  /**
   *  Following constant representing the possible value of property {@link #FORMAT}
   *  It means that the parser supports json format.
   */
