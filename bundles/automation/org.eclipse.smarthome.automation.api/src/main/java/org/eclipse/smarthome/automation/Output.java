 ...
 * <li>reference - reference to data source. It defines what part of complex
 * data (i.e. JavaBean, java.lang.Map etc.) has to be used as value of this
 * output.
 * </ul>
 * Outputs are exit points of a {@link Module}. They are used as data source for
 * {@link Input}s of other {@link Module}s. The {@link Output} can be connected
...
public class Output {
   ...
   *          restrictions to connections between {@link Input}s and
   *          {@link Output}s. The input tags must be subset of the output tags
   ...
   *          output.
   */
  public Output(String name, String type, String label, String description,
                Set<String> tags, String reference, Object defaultValue) {
    if (name == null)
   ...
   * additional restrictions to connections between {@link Input}s and
   * {@link Output}s. The input tags must be subset of the output tags to
