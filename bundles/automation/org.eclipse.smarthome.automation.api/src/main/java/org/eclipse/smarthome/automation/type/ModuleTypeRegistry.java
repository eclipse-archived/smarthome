...
public interface ModuleTypeRegistry extends Registry<ModuleType, String> {
     ...
     *
     * @param locale        used for localization of the ModuleType
     * @param moduleTypeTag specifies the filter for getting the ModuleTypes, if it is <code>null</code> then returns
     *                      all ModuleTypes.
     * @param               <T> the type of the required object
     * @return the ModuleTypes, which correspond to the filter.
     */
     ...
     * @param tags   specifies the filter for getting the {@link TriggerType}s, if it is <code>null</code> then returns
     *               all {@link TriggerType}s.
     ...
     * localized by default locale.
     *
     * @param tags specifies the filter for getting the {@link ConditionType}s, if it is <code>null</code> then returns
     *             all {@link ConditionType}s.
     ...
     * @param tags   specifies the filter for getting the {@link ConditionType}s, if it is <code>null</code> then
     *               returns all {@link ConditionType}s.
     ...
     * localized by default locale.
     *
     * @param tags specifies the filter for getting the {@link ActionType}s, if it is <code>null</code> then returns all
     *             {@link ActionType}s.
     ...
     * @param tags   specifies the filter for getting the {@link ActionType}s, if it is <code>null</code> then returns
     *               all {@link ActionType}s.
