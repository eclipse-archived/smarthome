 ...
 * <li>is required(optional) - defines if the Parameter is required or optional.
 * If missing the value is true.</li>
 * </ul>
...
public class Input {
   ...
   */
  public Input(String name, String type, String label, String description,
               Set<String> tags, boolean required, Object defaultValue) {
    if (name == null)
