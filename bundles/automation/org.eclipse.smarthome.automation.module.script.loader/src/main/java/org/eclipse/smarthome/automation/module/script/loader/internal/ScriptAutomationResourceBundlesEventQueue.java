 ...
 *
 * This is a modified copy of the AutomationResourceBundlesEventQueue
 *
 * @author Simon Merschjohann
 *
 */
public class ScriptAutomationResourceBundlesEventQueue implements Runnable, BundleTrackerCustomizer<Object> {
    ...
    /**
     * This field holds a reference to the script loader
     */
    private ScriptResourceImporter scriptResources;
     ...
     * @param scriptResources is the reference to the script loader
     */
    public ScriptAutomationResourceBundlesEventQueue(BundleContext bc, ScriptResourceImporter scriptResources) {
    ...
    private boolean isAnAutomationProvider(Bundle bundle) {
        URL url = bundle.getEntry(ScriptResourceImporter.PATH);
    ...
    private void processBundleChanged(BundleEvent event) {
        ...
        switch (event.getType()) {
            case BundleEvent.UPDATED:
                scriptResources.processAutomationProviderUninstalled(bundle);
                scriptResources.processAutomationProvider(bundle);
                break;
