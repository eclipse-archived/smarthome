 ...
 *
 */
public class DemoCommandsPluggable implements ConsoleCommandExtension {
    ...
    /**
     * This method is used to return the correct {@link DemoCommand} instance for execution.
     *
     * @param command - the name of the command.
     * @param params - array of strings which are basis for initialising the options and parameters of the command.
     * @return
     */
    protected DemoCommand parseCommand(String command, String[] params) {
    ...
    protected String buildCommandUsage(final String syntax, final String description) {
        return String.format("%s %s - %s", NAME, syntax, description);
    }
}
