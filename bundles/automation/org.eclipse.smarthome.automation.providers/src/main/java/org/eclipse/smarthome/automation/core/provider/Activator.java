...
public class Activator/*<T extends ModuleTypeProvider, S extends TemplateProvider>*/implements BundleActivator {
  ...
  public void start(BundleContext context) throws Exception {
    ...
    mtpReg = (ServiceRegistration/*<T>*/) bc.registerService(new String[] {
        ModuleTypeProvider.class.getName(), ModuleTypeProvider.class.getName()
    }, mProvider, null);

    tpReg = (ServiceRegistration/*<S>*/) bc.registerService(new String[] {
        TemplateProvider.class.getName(), TemplateProvider.class.getName()
    }, tProvider, null);
