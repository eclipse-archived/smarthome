...
public class cross_test_client implements DBus.Binding.TestClient, DBusSigHandler<DBus.Binding.TestSignals.Triggered> {
    ...
    public static void test(Class<? extends DBusInterface> iface, Object proxy, String method, Object rv,
            Object... parameters) {
        try {
    ...
    public static void doTests(DBus.Peer peer, DBus.Introspectable intro, DBus.Introspectable rootintro,
            DBus.Binding.Tests tests, DBus.Binding.SingleTests singletests) {
        Random r = new Random();
        int i;
    ...
    public static void testArray(Class<? extends DBusInterface> iface, Object proxy, String method,
            Class<? extends Object> arrayType, Object content) {
    ...
    public static void main(String[] args) {
        try {
            ...
            DBus.Binding.Tests tests = conn.getRemoteObject("org.freedesktop.DBus.Binding.TestServer", "/Test",
                    DBus.Binding.Tests.class);
            DBus.Binding.SingleTests singletests = conn.getRemoteObject("org.freedesktop.DBus.Binding.TestServer",
            ...
            DBus.Introspectable intro = conn.getRemoteObject("org.freedesktop.DBus.Binding.TestServer", "/Test",
                    DBus.Introspectable.class);

            DBus.Introspectable rootintro = conn.getRemoteObject("org.freedesktop.DBus.Binding.TestServer", "/",
                    DBus.Introspectable.class);
