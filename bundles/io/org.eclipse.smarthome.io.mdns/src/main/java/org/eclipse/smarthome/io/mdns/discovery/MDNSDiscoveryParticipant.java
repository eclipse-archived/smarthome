...
/**
 * A {@link MDNSDiscoveryParticipant} that is registered as a service is picked up by the
 * {@link MDNSDiscoveryService} and can thus contribute {@link DiscoveryResult}s from
 * mDNS scans.
 * 
