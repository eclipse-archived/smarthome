...
/**
 * The {@link XmlDocumentProviderFactory} is responsible to create {@link XmlDocumentProvider}
 * instances for any certain module. The factory is <i>not</i> responsible to clean-up any
 * created providers.
 * <p>
 * The {@link XmlDocumentProviderFactory} is used by the {@link XmlDocumentBundleTracker}
 * to create for each module an own {@link XmlDocumentProvider} instance to process any
 * result objects from the XML conversion.
 * 
