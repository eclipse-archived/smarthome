 ...
 * <p>
 * This class <i>DOES NOT</i> support XML tags with attributes <i>AND</i> values,
 * it only supports attributes.
 * <p>
 * This class can be used for an intermediate conversion result of attributes for an XML tag.
 * The conversion can be done by using the according {@link NodeAttributesConverter}.
 * <p>
...
public class NodeAttributes implements NodeName {
     ...
     */
    public NodeAttributes(String nodeName, Map<String, String> attributes)
