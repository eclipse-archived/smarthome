...
public final class Activator implements BundleActivator {
     ...
     *
     * @throws NullPointerException if bundle context is not available
     */
    public static final BundleContext getBundleContext() {
        if (bundleContext == null) {
            throw new NullPointerException("There is no bundle context");
        }
     ...
     *
     * @throws NullPointerException if config description registry is not available
     **/
    public static final ConfigDescriptionRegistry getConfigDescriptionRegistry() {
        if (configDescriptionRegistry == null) {
            throw new NullPointerException("There is no config description registry");
        }
     ...
     *
     * @throws NullPointerException if i18nProvider is not available
     **/
    public static final I18nProvider getI18nProvider() {
        if (i18nProvider == null) {
            throw new NullPointerException("There is no I18nProivder");
        }
        return i18nProvider;
    }
